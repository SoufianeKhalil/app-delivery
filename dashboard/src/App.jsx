  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/merchant/orders" element={<ProtectedRoute allowedRoles={["commercant", "admin"]}><Orders /></ProtectedRoute>} />
        <Route path="/merchant/products" element={<ProtectedRoute allowedRoles={["commercant", "admin"]}><Products /></ProtectedRoute>} />
        <Route path="/profile" element={<ProtectedRoute allowedRoles={["commercant", "admin"]}><MerchantProfile /></ProtectedRoute>} />
